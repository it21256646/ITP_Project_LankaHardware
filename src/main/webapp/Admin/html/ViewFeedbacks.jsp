...
<style>
  ...
  <body>
	...
	<!-- charts -->
	<li class="menu-item"><a href="productManagerCharts.jsp"
	...
	<!-- Forms -->
	<!-- Tables -->
	<li class="menu-item" id="new"><a href="productQuestions.jsp"
		class="menu-link"> <i
			...
			<div data-i18n="Tables">
				New Questions <span
					...
					id="newMessagesCount">0</span>
			</div>
	</a></li>
	<li class="menu-item" id="answered"><a href="productQuestions.jsp"
		 class="menu-link"> <i
			class="menu-icon tf-icons bx bx-table"></i>
			<div data-i18n="Tables">Answered Questions</div>
	</a></li>
	<li class="menu-item active" id=""><a href="#"
		onclick="return false;" class="menu-link"> <i class="menu-icon tf-icons bx bx-table"></i>
