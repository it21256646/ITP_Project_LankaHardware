...
<body>
	...
	<div class="layout-wrapper layout-content-navbar">
		<div class="layout-container">
            ...
            <li class="menu-item active" id="">
              <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">View Employees <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-danger" id="newMessagesCount">0</span></div>
              </a>
            </li>
				...
				<footer class="content-footer footer bg-footer-theme">
					<div
						...
						<div class="mb-2 mb-md-0">
							...
							, Lanka Hardware <a href="https://themeselection.com"
	...
	<div class="modal fade" id="AddSupplierModal" tabindex="-1"
					...
					<form id="formAccountSettings" method="POST"
						...
						<div class="row">
							...
							<div class="mb-3 col-md-6">
								<label for="lastName" class="form-label">Name</label> <input
							...
							<div class="mb-3 col-md-6">
								...
								<div class="input-group input-group-merge">
									<span class="input-group-text">LK (+94)</span> <input
										type="text" id="phoneNum" name="phoneNum" class="form-control" />
								</div>
							</div>

							<div class="mb-3 col-md-6">
								<label class="form-label" for="description">Supplier
									Description</label>
								<textarea name="description" id="description" cols="30" rows="7"
									class="form-control" placeholder="Description"></textarea>
							</div>
							<div class="mb-3 col-md-6">
								<label for="debit" class="form-label">Debit Or Credit</label> <select
									id="supplier_type" name="debit" class="select2 form-select">
						...
						<div class="mt-2">
							<button type="submit" class="btn btn-primary me-2" id="save"
								onclick="callAddSupplierServlet()">Add Supplier</button>

							<button type="reset" class="btn btn-outline-secondary" id="clear"
								onclick="clearemployee()">Cancel</button>
		...
		<div class="modal-footer" id="AddSupplierFooter">
			...
			<button type="button" class="btn btn-primary"
				onclick="callAddSupplierServlet()">Submit</button>
		</div>
	</div>
	</div>
	</div>
	...
	<div class="modal fade" id="EditSupplierModal" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header" id="editSupplierModalHeader"></div>
				<div class="modal-body" id="editSupplierModalBody"></div>
				<hr class="my-0" />
	...
	<div class="modal fade" id="deleteSupplierModal" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header" id="deleteSupplierModalHeader"></div>
				<div class="modal-body" id="deleteSupplierModalBody"></div>
				<div class="modal-footer" style="justify-content: center;"
					id="deleteSupplierModalFooter"></div>
			</div>
		</div>
	</div>
