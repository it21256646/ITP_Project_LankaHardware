...
>
  <head>
    ...
    <title>Voucher Management - Add Voucher</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Voucher Management/</span> Add New Voucher</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <br>
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" id = "save" onclick ="callAddEmployeeServlet()">Add Voucher</button>
