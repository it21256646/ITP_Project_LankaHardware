        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Stock Management/</span> Update Stock</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <small class="text-muted float-end">Bar</small>
                    </div>
                    <div class="card-body">
                      <form>
                      
                      <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Stock ID</label>
                        ...
                        <div class="mb-3">
                          ...
                          <textarea
                            ...
                            class="form-control"
                            placeholder="Add Description for the Stock"
                          ></textarea>
                        </div>
